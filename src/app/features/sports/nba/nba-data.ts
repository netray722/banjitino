...
import { EspnBoxScorePayload, EspnScoreboardPayload, NbaBoxScorePayload, NbaScoreboardPayload, RawEspnAthleteStats, RawEspnBoxTeam, RawEspnCompetitor, RawEspnPlayerGroup, RawEspnStatBlock, RawPlayer, RawStatistics, RawStatsResultSet, RawTeam, StatsScoreboardPayload } from './nba-data.types';
import { BoxScore, BoxScoreTeam, GameStatus, NbaGame, PlayerStats, Scoreboard, TeamSummary } from './nba.types';
